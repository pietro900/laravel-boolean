...
<div class="jumbotron-container">
    <section>
            ...
            <p>
                Le nostre risposte a tutte le tue domande. Non trovi la risposta che stai cercando? <a href="#">Contattaci</a> e saremo felici di darti una mano.
            </p>
        </section>
</div>
<div class="jumbotron">
    <div class="left">
                ...
                <section class="faq-body-question">
                    <h3 class="domanda">
                        Che competenze devo avere per iniziare il corso?<i class="fas fa-plus"></i>
                    </h3>
                    <p class="risposta">
                ...
                <section class="faq-body-question">
                    <h3 class="domanda">
                        In cosa consiste il processo di selezione?<i class="fas fa-plus"></i>
                    </h3>
                    <p class="risposta">
                ...
                <section class="faq-body-question">
                    <h3 class="domanda">
                        Posso seguire il corso mentre lavoro o studio?<i class="fas fa-plus"></i>
                    </h3>
                    <p class="risposta">
                ...
                <section class="faq-body-question">
                    <h3 class="domanda">
                        Di cosa ho bisogno per seguire il corso?<i class="fas fa-plus"></i>
                    </h3>
                    <p class="risposta">
                ...
                <section class="faq-body-question">
                    <h3 class="domanda">
                        Questo corso è una valida alternativa alla laurea?<i class="fas fa-plus"></i>
                    </h3>
                    <p class="risposta">
                ...
                <section class="faq-body-question">
                    <h3 class="domanda">
                        Quanto costa il corso?<i class="fas fa-plus"></i>
                    </h3>
                    <p class="risposta">
                        Trovi tutte le informazioni sul prezzo nell'
                    <a href="#">apposita sezione della pagina corso.</a>
                    </p>
                </section>
            </div>
    <div class="right">
                ...
                <section class="faq-body-question">
                    <h3 class="domanda">
                        Ho la certezza di essere assunto?<i class="fas fa-plus"></i>
                    </h3>
                    <p class="risposta">
                ...
                <section class="faq-body-question">
                    <h3 class="domanda">
                        Terminato il corso, sono supportato nella ricerca del lavoro?<i class="fas fa-plus"></i>
                    </h3>
                    <p class="risposta">
                ...
                <section class="faq-body-question">
                    <h3 class="domanda">
                        Quanti dei vostri ex allievi hanno ricevuto offerte di lavoro?
                        <i class="fas fa-plus"></i>
                    </h3>
                    <p class="risposta">
                ...
                <section class="faq-body-question">
                <h3 class="domanda">
                    Posso fare lo sviluppatore freelance al termine del corso?
                    <i class="fas fa-plus"></i>
                </h3>
                    <p class="risposta">
                ...
                <section class="faq-body-question">
                    <h3 class="domanda">
                        Troverò un lavoro nella mia città?
                        <i class="fas fa-plus"></i>
                    </h3>
                    <p class="risposta">
                ...
                <section class="faq-body-question">
                    <h3 class="domanda">
                        Che tipo di attestato rilasciate?
                        <i class="fas fa-plus"></i>
                    </h3>
                    <p class="risposta">
